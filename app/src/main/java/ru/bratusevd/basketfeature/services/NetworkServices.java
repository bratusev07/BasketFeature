package ru.bratusevd.basketfeature.services;
...
public class NetworkServices {
    ...
    private static final String BASE_URL = "BASE_URL"; //адрес сервера
    ...
    public REST_API getJSONApi() {
        return mRetrofit.create(REST_API.class);
    }
}